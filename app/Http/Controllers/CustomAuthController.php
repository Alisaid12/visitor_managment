...
class CustomAuthController extends Controller
{
    ...
    public function dashboard(){
        if(Auth::check())
        {
            ...
            // $visitorsLastMonth = Visiteur::where('created_at', '>=', Carbon::now()->subMonth()->startOfMonth())
...
// {
//     $chartData = // retrieve data for the chart

//     $pdf = PDF::loadView('chart_pdf', ['chartData' => $chartData]);
//     $excel = Excel::download(new ChartExport($chartData), 'chart.xlsx');

//     return view('chart', ['chartData' => $chartData, 'pdf' => $pdf, 'excel' => $excel]);
// }
