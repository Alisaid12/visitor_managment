...
@section('content')
    ...
    <body id="page-top">
        <h2 class="mt-2 mb-4"><u>Tableau de bord:</u></h2>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark mb-2">
                    ...
                    <div class="container-fluid">
                        ...
                        {{-- <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                                        ...
                                        <i class="fas fa-bell text-white" id="bell-icon"></i>
                                        <span
        ...
        {{-- <ul class="notification-drop">
                <li class="item">
                    <i class="fa fa-bell-o notification-bell" aria-hidden="true"></i> <span
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7">
                <button id="downloadExcel" class="btn btn-light">exporter vers Excel</button>
                <button id="downloadPDF" class="btn btn-light">exporter vers PDF</button>
            ...
            <div class="col-xl-4 col-lg-5">
                <!-- Pie Chart Card -->
                <div class="card shadow mb-4">
                    <button id="export-to-excel-btn" class="btn btn-light">exporter vers Excel</button>
                    <button id="export-to-pdf-btn" class="btn btn-light">exporter vers PDF</button>
