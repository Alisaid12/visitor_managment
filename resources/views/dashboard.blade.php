...
<body>
    ...
    @else
        ...
        <header class="navbar navbar-dark sticky-top bg-light flex-md-nowrap p-0 shadow " style="width: 1500px;">
        ...
        <div class="container-fluid my-10">
            <div class="row">
                <nav id="sidebarMenu" class="navbar-dark col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <h3 class="pt-4 px-4"><u>CCIS</u></h3>
