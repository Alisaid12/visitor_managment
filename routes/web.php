...
// Route::get('/visitor/{id}/edit', [SuivieVisiteurController::class, 'edit'])->name('visitors.edit');
...
// Route::get('/autocomplete/fetch', [VisiteurController::class, 'fetch'])->name('autocomplete.fetch');
